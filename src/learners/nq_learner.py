...
class NQLearner:
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int):
        ...
        # 更新当前训练步数
        # self.current_training_step = t_env
        ...
        if t_env - self.log_stats_t >= self.args.learner_log_interval:
            ...
            # self.logger.log_stat("td_lambda", self.td_lambda, t_env)  # 记录当前 td_lambda 值
    ...
    def _update_targets(self):
        ...
        # # 根据当前训练进度比例更新 td_lambda
        # progress_ratio = min(1.0, self.current_training_step / self.total_training_steps)
        # # 线性衰减: 从 max_td_lambda 到 min_td_lambda
        # self.td_lambda = self.max_td_lambda - (self.max_td_lambda - self.min_td_lambda) * progress_ratio
        # self.logger.console_logger.info(f"Updated td_lambda to {self.td_lambda:.4f} at training step {self.current_training_step}")
